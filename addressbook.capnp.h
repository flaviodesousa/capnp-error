...
#ifndef CAPNP_INCLUDED_c6634e616fde8375_
#define CAPNP_INCLUDED_c6634e616fde8375_
...
CAPNP_DECLARE_SCHEMA(c4da79000aaa5df8);
CAPNP_DECLARE_SCHEMA(ae0868be6444f16f);
CAPNP_DECLARE_SCHEMA(91572dbaef18751a);
enum class Type_91572dbaef18751a: uint16_t {
  MOBILE,
  HOME,
  WORK,
};
...
struct Person {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(c4da79000aaa5df8, 0, 4)
    #if !CAPNP_LITE
...
struct Person::PhoneNumber {
  ...
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::Type_91572dbaef18751a Type;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(ae0868be6444f16f, 1, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand = &schema->defaultBrand;
    #endif  // !CAPNP_LITE
  };
...
#endif  // CAPNP_INCLUDED_c6634e616fde8375_
